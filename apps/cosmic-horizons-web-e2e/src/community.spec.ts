...
test.fixme('community post requiring moderation is hidden until approved', async ({
  page,
  request,
}) => {
...
test.fixme('admin can hide a visible community post and UI updates accordingly', async ({
  page,
  request,
}) => {
