...
Scope anchor: `documentation/PRODUCT-CHARTER.md` + `SCOPE-LOCK.md`
...
- Storage: in-memory buffer by default; optional Redis list for durability. Runtime logs are never committed; see `documentation/LOGGING.md`.
...
- Charter and scope: `documentation/PRODUCT-CHARTER.md`, `SCOPE-LOCK.md`
...
- `documentation/DEMO.md` reproducible by a new reviewer in under 3 minutes.
