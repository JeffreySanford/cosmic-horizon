...
_Note: cloud costs exclude egress/requests. Multi‑cloud pricing negotiable._
...
Automated _recall jobs_ ship requested chunks back to cold tier; compute can be scheduled on incoming data.
