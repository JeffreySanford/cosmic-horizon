...
sprint and serves as a living plan for integrating _real astronomical
measurement sets_ into the existing jobs workflow. The content will be
...
but is not officially tested. We call this a _reference architecture
prototype_, not a production system.
